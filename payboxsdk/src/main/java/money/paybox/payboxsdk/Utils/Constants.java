...
public class Constants {
    ...
    public static final String PB_CANCEL_URL = "cancel.php";
    public static final String PB_DO_CAPTURE_URL = "do_capture.php";
    public static final String PB_RECURRING_URL = "make_recurring_payment.php";
