...
public class PBHelper implements PBResultReceiver.Receiver{
    ...
    public void makeRecurringPayment(int amount, String orderId, String recuringProfile, String description){
    ...
    public void initRevokePayment(int paymentId, int amount){
        HashMap<String, String> param = defParams();
        param.put(Constants.PB_PAYMENT_ID, String.valueOf(paymentId));
